...
export async function getSalesByCategory(storeId: string, categoryId: string) {
  const token = (await cookies()).get("token")?.value;
  ...
  try {
    const response = await fetch(
      `${apiUrl}/filterorderbycategory/${storeId}/${categoryId}`,
      {
        method: "GET",
        headers: {
          Authorization: `${token}`,
...
export async function getallOrderStatus() {
  ...
  // API endpoints
  const urls = {
    approved: `${apiUrl}/getapprovepo`,
    rejected: `${apiUrl}/getrejectpo`,
    pending: `${apiUrl}/getpendingpo`,
  };
...
////========================marketlist====================
export async function getOutOfStockList(storeId: string) {
  const token = (await cookies()).get("token")?.value;
  ...
  try {
    const response = await fetch(`${apiUrl}/marketlist/${storeId}`, {
      method: "GET",
      headers: {
        Authorization: `${token}`,
        "Content-Type": "application/json",
...
////========================Debtor====================
export async function getDebtorsList(storeId: string) {
  const token = (await cookies()).get("token")?.value;
  ...
  try {
    const response = await fetch(`${apiUrl}/pendingorder/${storeId}`, {
      method: "GET",
      headers: {
        Authorization: `${token}`,
        "Content-Type": "application/json",
